...
namespace Damian_Ionut_Lab2.Data
{
    public class Damian_Ionut_Lab2Context : DbContext
    {
        ...
        public DbSet<Damian_Ionut_Lab2.Models.Category> Category { get; set; } = default!;
        public DbSet<Damian_Ionut_Lab2.Models.Member> Member { get; set; } = default!;
        public DbSet<Damian_Ionut_Lab2.Models.Borrowing> Borrowing { get; set; } = default!;
    }
}
